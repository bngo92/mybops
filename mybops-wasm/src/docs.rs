...
pub fn docs() -> impl IntoView {
    crate::nav_content(
        ...
        view! {
          <div>
            <h1 class="tw:mb-2 tw:text-2xl tw:font-medium">"Item features"</h1>
            <h2 class="tw:text-xl tw:font-medium">"Rank items"</h2>
            <p class="tw:mb-2">
              "Rank items like your songs to figure out what your favorite songs are."
            </p>
            <h2 class="tw:text-xl tw:font-medium">"Rate items"</h2>
            <p class="tw:mb-2">
              "Item ratings provide a method for ranking/grouping your items using a scale of 1 to 10."
            </p>
            <h2 class="tw:text-xl tw:font-medium">"Query items"</h2>
            <p class="tw:mb-2">
            ...
            <h2 class="tw:text-xl tw:font-medium">"Manage items"</h2>
            <p class="tw:mb-4">
              "You can mark items as hidden for queries to filter on.
               You can also delete items to remove it from all lists and queries."
            </p>
            <h1 class="tw:mb-2 tw:text-2xl tw:font-medium">"List features"</h1>
            <h2 class="tw:text-xl tw:font-medium">"Create lists of items using data sources"</h2>
            <p class="tw:mb-2">
            ...
            <h2 class="tw:text-xl tw:font-medium">"Query items in a list"</h2>
            <p class="tw:mb-2">
            ...
            <h2 class="tw:text-xl tw:font-medium">"Integrate with external systems"</h2>
            <p class="tw:mb-2">
            ...
            <h2 class="tw:text-xl tw:font-medium">"Define a default query for the list"</h2>
            <p class="tw:mb-2">
              "The query will be used as the default query for the query view and any push actions."
            </p>
            <h2 class="tw:text-xl tw:font-medium">"Favorite lists"</h2>
            <p class="tw:mb-4">
              "Favorite lists will show up on the home page along with results from the default query."
            </p>
            <h1 class="tw:mb-2 tw:text-2xl tw:font-medium">"Combined features"</h1>
            <p class="tw:mb-2">
              "Create a Spotify playlist from other Spotify albums and playlists."
            </p>
            <p class="tw:mb-2">
              "Create a Spotify playlist from songs that you've rated 7 or above."
            </p>
            <p class="tw:mb-2">"Create a list from other lists to reuse the data sources."</p>
            <p class="tw:mb-2">"Create a table showing your average ratings by album."</p>
            <p class="tw:mb-2">
